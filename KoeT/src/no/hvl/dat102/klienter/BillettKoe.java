...
public class BillettKoe {
	private static final int PROSESSTID = 120;      // Gj.sn tid for å betjene en kunde
	private static final int MAKS_ANT_LUKER = 10;   // Antal billettluker
	private static final int ANT_KUNDER = 100;      // Antall kunder i alt

	public static void main(String[] a) {
		Kunde kunde;
		KoeADT<Kunde> kundekoe = new TabellSirkulaerKoe<>();
		// KoeADT<Kunde> kundekoe = new KjedetKoe<>();
